...
class TestHamamatsurxCam(unittest.TestCase):
    ...
    def test_acq_photon_counting(self):
        ...
        try:
            ...
            self.readoutcam.exposureTime.value = 20e-3
            self.readoutcam.integrationCounts.value = 100
        ...
        # TODO: test live with photon counting mode
        # TODO: test sync with photon counting mode
