...
class ZStackPlugin(Plugin):
    ...
    def __init__(self, microscope, main_app):
        ...
        # * for each Z, all the streams (aka itertwined): Z exactly the same for each stream
