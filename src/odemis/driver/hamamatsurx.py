...
class ReadoutCamera(model.DigitalCamera):
    ...
    def __init__(self, name, role, parent,
        ...
        self.integrationCounts = model.IntContinuous(integ_count, count_range, unit="",
    ...
    def _getCamExpTimeRange(self):
        ...
        """
        exp = self.parent.CamParamInfoEx("Live", "Exposure")  # returns list of possible exposure times
    ...
    def _setCamExpTime(self, value: float) -> float:
        ...
        # FIXME: need to set only in photon-counting mode?
        # TODO: the range is different in photon-counting mode (minimum value is ~ 1ms)
        try:
