...
class LocalizationTab(Tab):
    ...
    def __init__(self, name, button, panel, main_frame, main_data):
        ...
        # To avoid this, we interpolate the content.
        # The drawback of interpolation is that lowers the frame rate, which can be annoying when
        # manually focusing, so we don't activate it by default.
        if main_data.ccd.resolution.range[1][0] > 1200:  # px
