...
class Scanner(model.Emitter):
    ...
    It is possible to request an abritrary scan path, by using the .scanPath VA.
    ...
    def _set_scan_ttl(self, va_name: str, ttl: Optional[numpy.ndarray]) -> Optional[numpy.ndarray]:
        ...
        :param ttl: A 1D numpy array of shape (N,). The TTL data to set, for each pixel of scanPath.
