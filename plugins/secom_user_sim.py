...
from odemis.gui.model import TabName, MicroscopyGUIData
...
class SecomUserPlugin(Plugin):
    ...
    def start(self):
        ...
        dlg.addButton("Intensive use", self._sim_fluo_search, face_colour='blue')
    ...
    def _init_sim(self, dlg) -> MicroscopyGUIData:
    ...
    def _get_fm_stream(self, tab_data) -> FluoStream:
    ...
    def _sim_intensive_use(self, dlg):
        """
