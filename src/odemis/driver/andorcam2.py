    ...
    def _configure_trigger_mode(self, synchronized):
        ...
        if trigger_mode == TRIG_NONE:
            ...
            if HW_TRIGGER_IS_2_FRAMES and self.useDoubleFrames.value:
                ...
                self.atcore.SetTriggerMode(AndorV2DLL.TM_EXTERNALSTART)
                if not self.IsTriggerModeAvailable(AndorV2DLL.TM_EXTERNALSTART):
...
#           self._gain = util.find_closest(value, gains)
        ...
        if HW_TRIGGER_IS_2_FRAMES and trigger_mode == TRIG_HW and self.useDoubleFrames.value:
            ...
            self.atcore.SetNumberKinetics(c_int32(5))
